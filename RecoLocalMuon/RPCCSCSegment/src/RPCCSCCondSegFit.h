#ifndef RPCCSCSegment_CSCCondSegFit_h
#define RPCCSCSegment_CSCCondSegFit_h

// CSCCondSegFit.h -- segment fit factored out of RPCCSCSegAlgoST - Tim Cox
// Last mod: 29.01.2015

/* This class extends basic RPCCSCSegFit with the complexities built into
 * the original entangled RPCCSCSegAlgoST extension of the RPCCSCSegAlgoSK fit.
 ...
 * the requirements of the CSC segment-building algorithm RPCCSCSegAlgoST.
 */
...
public:
  ...
  void correctTheCovMatrix(RPCCSCSegFit::SMatrixSym2& IC);
