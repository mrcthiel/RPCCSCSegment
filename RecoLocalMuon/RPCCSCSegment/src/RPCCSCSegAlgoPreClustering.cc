/**
 * \file RPCCSCSegAlgoPreClustering.cc
 *
 ...
 *
 */
RPCCSCSegAlgoPreClustering::RPCCSCSegAlgoPreClustering(const edm::ParameterSet& ps) {
 ...
 *
 */
RPCCSCSegAlgoPreClustering::~RPCCSCSegAlgoPreClustering(){
...
RPCCSCSegAlgoPreClustering::clusterHits( const CSCChamber* aChamber, const ChamberHitContainer& rechits) {
