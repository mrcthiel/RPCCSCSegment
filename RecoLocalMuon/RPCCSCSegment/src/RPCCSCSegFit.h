#ifndef RPCCSCSegment_RPCCSCSegFit_h
#define RPCCSCSegment_RPCCSCSegFit_h

// RPCCSCSegFit.h  - Segment fitting factored out of CSC segment builders - Tim Cox
// Last mod: 03.02.2015
...
// TYPES
  ...
  RPCCSCSegFit( const CSCChamber* csc, CSCSetOfHits hits) : 
  chamber_( csc ), hits_( hits ), scaleXError_( 1.0 ), fitdone_( false ) {}

  virtual ~RPCCSCSegFit() {}
